//CanvasTGA.js modified for side service use

//BAND 7 uses dialog chipset
//GTS uses nxp chipset, but we're not officially supporting it yet
const deviceChipset = "dialog";
